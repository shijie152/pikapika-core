...
func comics(params string) (string, error) {
	...
	return cacheable(
		fmt.Sprintf("COMICS$%s$%s$%s$%s$%s$%s$%d", paramsStruct.Category, paramsStruct.Tag, paramsStruct.Author, paramsStruct.CreatorId, paramsStruct.ChineseTeam, paramsStruct.Sort, paramsStruct.Page),
		time.Hour*2,
		func() (interface{}, error) {
			return client.Comics(paramsStruct.Category, paramsStruct.Tag, paramsStruct.Author, paramsStruct.CreatorId, paramsStruct.ChineseTeam, paramsStruct.Sort, paramsStruct.Page)
		},
	)
}
